...
import com.infozealrecon.android.util.GmailSender;
import com.infozealrecon.android.util.Utils;
...
public class BackgroundMail {
    ...
    public BackgroundMail(Context context) {
        ...
        this.sendingMessage = context.getString(com.infozealrecon.android.R.string.msg_sending_email);
        this.sendingMessageSuccess = context.getString(com.infozealrecon.android.R.string.msg_email_sent_successfully);
        this.sendingMessageError = context.getString(com.infozealrecon.android.R.string.msg_error_sending_email);
    }
